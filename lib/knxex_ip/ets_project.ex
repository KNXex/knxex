defmodule KNXexIP.EtsProject do
  @moduledoc """
  KNX ETS project.
  """
  ...
  @type t :: %__MODULE__{
          ...
          group_addresses: %{
            optional(id_or_address :: String.t()) => KNXexIP.EtsProject.GroupAddressInfo.t()
          },
          locations: nil,
          topology: %{
            optional(address :: non_neg_integer()) => KNXexIP.EtsProject.Topology.Area.t()
          },
          unassigned_devices: [KNXexIP.EtsProject.Topology.Device.t()]
        }
  ...
  defmodule Topology.Area do
    ...
    @type t :: %__MODULE__{
            ...
            lines: %{
              optional(address :: non_neg_integer()) => KNXexIP.EtsProject.Topology.Line.t()
            }
          }
  ...
  defmodule Topology.Line do
    ...
    @type t :: %__MODULE__{
            name: String.t(),
            medium_type: KNXexIP.EtsProject.medium(),
            address: {area :: non_neg_integer(), line :: non_neg_integer()},
            devices: %{
              optional(address :: non_neg_integer()) => KNXexIP.EtsProject.Topology.Device.t()
            }
          }
  ...
  defmodule Topology.Device do
    ...
    @type t :: %__MODULE__{
            ...
            completion_status: KNXexIP.EtsProject.completion_status(),
            last_modified: NaiveDateTime.t() | nil,
  ...
  defmodule Manufacturer.Hardware.Hardware2Program do
    ...
    @type t :: %__MODULE__{
            id: String.t(),
            medium_types: [KNXexIP.EtsProject.medium()],
            hash: String.t(),
  ...
  defmodule Manufacturer.ApplicationProgram do
    ...
    @type t :: %__MODULE__{
            ...
            hash: String.t(),
            com_objects: %{
              optional(refid :: String.t()) => KNXexIP.EtsProject.Topology.Device.ComObject.t()
            }
          }
