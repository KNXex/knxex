defmodule KNXexIP.DIB do
  ...
  alias KNXexIP.DIB
  alias KNXexIP.PID.IPAssignmentMethod
  ...
  @type dib ::
          ...
          | {:knx_addresses,
             {KNXexIP.IndividualAddress.t(), additional :: [KNXexIP.IndividualAddress.t()]}}
  ...
  defp parse_device_info(
    ...
    %DIB.DeviceInfo{
      ...
      address: KNXexIP.IndividualAddress.from_raw_address(individual_address),
  ...
  defp parse_knx_addresses(<<address::size(16), rest::binary>>) do
    {KNXexIP.IndividualAddress.from_raw_address(address), parse_additional_knx_addresses(rest)}
  end
  ...
  defp encode_dib({:device_info, %DIB.DeviceInfo{} = device_info}) do
    ...
    <<Constants.macro_by_name(:dib_type, :device_info)::size(8),
      ...
      KNXexIP.IndividualAddress.to_raw_address(device_info.address)::size(16),
  ...
  defp encode_dib({:knx_addresses, {knx_addresses, add_knx_addresses}}) do
    <<Constants.macro_by_name(:dib_type, :knx_addresses)::size(8),
      KNXexIP.IndividualAddress.to_raw_address(knx_addresses.address)::size(16),
  ...
  defp encode_additional_knx_addresses([address | tail]) do
    <<KNXexIP.IndividualAddress.to_raw_address(address)::size(16),
