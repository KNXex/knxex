defmodule KNXexIP.ProjectParser do
  @moduledoc """
  ...
  @before_compile KNXexIP.ProjectParser.Topology
  @before_compile KNXexIP.ProjectParser.GroupAddresses
  @before_compile KNXexIP.ProjectParser.Manufacturer

  @doc """
  Parses a KNX project file (ETS .knxproj), extracting project information and returns a `KNXexIP.EtsProject` struct.
  ...
  """
  @spec parse(binary(), Keyword.t()) :: KNXexIP.EtsProject.t()
  def parse(path, opts \\ []) when is_binary(path) and is_list(opts) do
    ...
    case get_project_xml_from_zip(path, new_opts) do
      {:ok, project_files} ->
        Enum.reduce(project_files, KNXexIP.EtsProject.new(path), fn
  ...
  %{
    "M-00C9" => %{
      application_programs: %{
        "M-00C9_A-FF14-20-223D" => %KNXexIP.EtsProject.Manufacturer.ApplicationProgram{
          app_number: "65300",
          app_version: "32",
          com_objects: %{
            "O-12" => %KNXexIP.EtsProject.Topology.Device.ComObject{
      ...
      hardware: %{
        "M-00C9_H-70121-1" => %KNXexIP.EtsProject.Manufacturer.Hardware{
          bus_current: 10,
          hardware2programs: %{
            "M-00C9_H-70121-1_HP-FF14-20-223D" => %KNXexIP.EtsProject.Manufacturer.Hardware.Hardware2Program{
          ...
          name: "KNX T-AP",
          products: %{
            "M-00C9_H-70121-1_P-70121" => %KNXexIP.EtsProject.Manufacturer.Hardware.Product{
  ...
  @spec parse_manufacturers(binary(), Keyword.t()) :: %{
          optional(manufacturer_id :: String.t()) => %{
            hardware: %{
              optional(id :: String.t()) => KNXexIP.EtsProject.Manufacturer.Hardware.t()
            },
            application_programs: %{
              optional(id :: String.t()) => KNXexIP.EtsProject.Manufacturer.ApplicationProgram.t()
            }
          }
        }
  ...
  @spec parse_project(term(), KNXexIP.EtsProject.t(), map()) ::
  ...
  @spec parse_installation(term(), KNXexIP.EtsProject.t(), map()) ::
          KNXexIP.EtsProject.t()
  ...
  @spec parse_completion_status(binary()) :: KNXexIP.EtsProject.completion_status()
