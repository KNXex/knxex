...
defmodule KNXexIP.ProjectParser.Topology do
  @moduledoc false
  ...
  defmacro __before_compile__(_env) do
    ...
    quote location: :keep do
      ...
      @spec parse_topology_area(
              ...
              {KNXexIP.EtsProject.t(), area_address :: non_neg_integer()}
      defp parse_topology_area(xml_area, ets_project, _parent_area, _opts) do
        ...
        case base_info do
          ...
          _any ->
            area = KNXexIP.to_struct!(base_info, KNXexIP.EtsProject.Topology.Area)
      ...
      @spec parse_topology_line(
              ...
              {KNXexIP.EtsProject.t(), line_address :: non_neg_integer()}
        ...
        case base_info do
          ...
          _any ->
            line =
              ...
              |> KNXexIP.to_struct!(KNXexIP.EtsProject.Topology.Line)
            ...
            new_ets =
              ...
              |> Map.update!(:topology, fn map ->
                ...
                Map.update!(map, area_address, fn area ->
                  ...
                  |> KNXexIP.to_struct!(KNXexIP.EtsProject.Topology.Area)
                end)
              end)
              |> KNXexIP.to_struct!(KNXexIP.EtsProject)
      ...
      @spec parse_topology_device(
              ...
              non_neg_integer(),
              map()
            ) :: KNXexIP.EtsProject.Topology.Device.t() | nil
      defp parse_topology_device(
        ...
        base_info =
          Enum.reduce(
            ...
            %{
              ...
              last_modified: nil,
              last_download: nil,
              device_status: %KNXexIP.EtsProject.Topology.Device.Status{},
              parameters: %{},
              com_objects: %{}
            },
            fn
              ...
              acc ->
                ...
                address =
                  KNXexIP.IndividualAddress.make(area_address, line_address, device_address)
              ...
              acc ->
                device_status =
                  ...
                  |> KNXexIP.to_struct!(KNXexIP.EtsProject.Topology.Device.Status)
        ...
        case base_info do
          ...
          _any ->
            ...
            |> KNXexIP.to_struct!(KNXexIP.EtsProject.Topology.Device)
        end
      end
              ...
              acc ->
                new_object =
                  parse_device_com_object(
                    attribs,
                    %KNXexIP.EtsProject.Topology.Device.ComObject{}
                  )
      ...
      @spec parse_device_com_object(term(), map()) ::
              KNXexIP.EtsProject.Topology.Device.ComObject.t()
      defp parse_device_com_object(xml_attribs, comobjects_map) do
        ...
        |> KNXexIP.to_struct!(KNXexIP.EtsProject.Topology.Device.ComObject)
      end
      ...
      @spec parse_medium_type(binary()) :: KNXexIP.EtsProject.medium()
