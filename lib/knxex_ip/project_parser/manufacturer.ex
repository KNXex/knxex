...
defmodule KNXexIP.ProjectParser.Manufacturer do
  @moduledoc false
  ...
  defmacro __before_compile__(_env) do
    ...
    quote location: :keep do
      ...
      defp parse_manufacturer_hardware(
        ...
        hwprod = %KNXexIP.EtsProject.Manufacturer.Hardware{
          hardware
      ...
      @spec parse_manufacturer_hardware_attribs(term()) ::
              KNXexIP.EtsProject.Manufacturer.Hardware.t()
      defp parse_manufacturer_hardware_attribs(attribs) do
        ...
        |> KNXexIP.to_struct!(KNXexIP.EtsProject.Manufacturer.Hardware)
      end
      ...
      defp parse_manufacturer_product(attribs) do
        ...
        |> KNXexIP.to_struct!(KNXexIP.EtsProject.Manufacturer.Hardware.Product)
      end
      ...
      defp parse_manufacturer_hardware2program_mapping(attribs, appprog_refid) do
        ...
        |> KNXexIP.to_struct!(KNXexIP.EtsProject.Manufacturer.Hardware.Hardware2Program)
      end
      ...
      defp parse_manufacturer_app_program(
        ...
        app_prg = %KNXexIP.EtsProject.Manufacturer.ApplicationProgram{
          app
      ...
      @spec parse_manufacturer_app_program_attribs(term()) ::
              KNXexIP.EtsProject.Manufacturer.ApplicationProgram.t()
      defp parse_manufacturer_app_program_attribs(attribs) do
        ...
        |> KNXexIP.to_struct!(KNXexIP.EtsProject.Manufacturer.ApplicationProgram)
      end
