defmodule KNXexIP.Frames.RoutingIndicationFrame.Data do
  @moduledoc """
  ...
  """
  @type t :: %__MODULE__{
          control_field: KNXexIP.CEMIControlField.t(),
          tpci: KNXexIP.TPCI.t(),
          apci: apci() | non_neg_integer(),
          source: KNXexIP.IndividualAddress.t(),
          destination_type: :group | :individual,
          destination: KNXexIP.GroupAddress.t() | KNXexIP.IndividualAddress.t(),
          value: bitstring()
        }
