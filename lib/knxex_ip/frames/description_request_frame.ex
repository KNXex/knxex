defmodule KNXexIP.Frames.DescriptionRequestFrame do
  @moduledoc """
  ...
  defmacro __using__(_any) do
    quote location: :keep do
      def decode_frame(
        ...
        {:ok,
         %KNXexIP.Frames.DescriptionRequestFrame{
  ...
  defimpl KNXexIP.Frames.FrameEncoder do
    ...
    def encode(%{} = frame, Constants.macro_by_name(:knx, :protocol_version_10))
        when is_struct(frame, KNXexIP.Frames.DescriptionRequestFrame) do
      struct =
