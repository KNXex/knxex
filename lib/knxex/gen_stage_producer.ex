if Code.ensure_loaded?(GenStage) do
  defmodule KNXex.GenStageProducer do
    @moduledoc """
    ...
    def subscribe_to(knx_interface, name_or_pid \\ nil, opts \\ [])
      ...
      if knx_interface != KNXex.GroupAddressServer and
           knx_interface != KNXex.MulticastClient and
           knx_interface != KNXex.TunnelClient do
        raise ArgumentError,
