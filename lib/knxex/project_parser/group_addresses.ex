...
defmodule KNXex.ProjectParser.GroupAddresses do
  @moduledoc false
  ...
  defmacro __before_compile__(_env) do
    ...
    quote location: :keep do
      @spec parse_group_ranges(term(), KNXex.EtsProject.t(), map()) ::
              KNXex.EtsProject.t()
      ...
      @spec parse_group_address(term(), KNXex.EtsProject.t(), map()) ::
              KNXex.EtsProject.t()
        ...
        case base_info do
          ...
          _any ->
            ...
            info =
              ...
              |> Map.put(:address, %KNXex.GroupAddress{
                main: addr_main,
                middle: addr_middle,
                sub: addr_sub
              })
              |> KNXex.to_struct!(KNXex.EtsProject.GroupAddressInfo)
            ...
            |> Map.update!(:group_addresses, fn map ->
              Map.put(
                ...
                if(key_by == :id,
                  do: info.id,
                  else: KNXex.GroupAddress.to_string(info.address)
                ),
                info
              )
            end)
